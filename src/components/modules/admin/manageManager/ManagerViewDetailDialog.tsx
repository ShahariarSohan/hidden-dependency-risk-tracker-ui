...
interface IManagerViewDialogProps {
  open: boolean;
  onClose: () => void;
  manager: IManager | null;
}

const ManagerViewDetailDialog = ({
  open,
  onClose,
  manager,
}: IManagerViewDialogProps) => {
        ...
        <div className="flex-1 overflow-y-auto px-6 pb-6">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 p-6 bg-linear-to-br from-blue-50 to-indigo-50 dark:from-blue-950 dark:to-indigo-950 rounded-lg mb-6">
            ...
            <div className="flex-1 text-center sm:text-left">
              <h2 className="text-3xl font-bold mb-1">{manager?.name}</h2>
              ...
              <div className="flex flex-wrap gap-2 justify-center sm:justify-start">
                <Badge
                  variant={manager?.isDeleted ? "destructive" : "default"}
                  className="text-sm"
                >
                  {manager?.isDeleted ? "Inactive" : "Active"}
                </Badge>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-muted/50 p-4 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <InfoRow
                    ...
                    value={manager?.contactNumber || "Not provided"}
                  />
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <InfoRow
                    label="Email"
                    value={manager?.email || "Not provided"}
                  />
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-muted/50 p-4 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <InfoRow
                    label="Created On"
                    value={formatDateTime(manager?.createdAt || "")}
                  />
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <InfoRow
                    label="Last Updated"
                    value={formatDateTime(manager?.updatedAt || "")}
                  />
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <InfoRow
                    ...
                    value={manager?.isDeleted ? "Inactive" : "Active"}
                  />
                </div>
              </div>
            </div>
...
export default ManagerViewDetailDialog;
