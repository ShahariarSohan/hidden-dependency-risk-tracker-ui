...
export default async function PublicNavbarServer() {
  ...
  const dashboardPath=accessToken? getDefaultDashboardRoute(userInfo.role as UserRole):""
 
  
  return <PublicNavbarClient accessToken={accessToken} dashboardPath={dashboardPath}></PublicNavbarClient>;
}
